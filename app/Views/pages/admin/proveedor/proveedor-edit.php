      ...
      <div class="card w-100">
        <div class="card-body p-4">
          <div class="d-flex justify-content-between align-items-center">
            <h5 class="card-title fw-semibold m-0">Editar Proveedor</h5>
            <a href="<?= base_url('settings/proveedor') ?>" class="btn btn__simple border d-block"><i class="ti ti-arrow-back"></i> Volver</a>
          </div>
          <form method="post" class="pt-4" action="<?= base_url('proveedor/edit') ?>">
            <?php echo csrf_field(); ?>
              ...
              <div class="col-md-4">
                <div class="mb-3">
                  ...
                  <div class="input-group">
                    <span class="input-group-text"><i class="ti ti-topology-complex"></i></span>
                    <input 
                      value="<?= $proveedor->fecha_inicio_operaciones ?>"
                      placeholder="Sitio Web"
                      type="date" 
              ...
              <div class="col-md-4">
                <div class="mb-3">
                  ...
                  <div class="input-group">
                    <span class="input-group-text"><i class="ti ti-topology-complex"></i></span>
                    <input 
                      value="<?= $proveedor->contacto_email ?>"
              ...
              <div class="col-md-4">
                <div class="mb-3">
                  ...
                  <div class="input-group">
                    <span class="input-group-text"><i class="ti ti-topology-complex"></i></span>
                    <input 
                      value="<?= $proveedor->contacto_telefono ?>"
              ...
              <div class="col-md-4">
                <div class="mb-3">
                  ...
                  <div class="input-group">
                    <span class="input-group-text"><i class="ti ti-topology-complex"></i></span>
                    <input 
                      value="<?= $proveedor->oficina_calle_numero ?>"
              ...
              <div class="col-md-4">
                <div class="mb-3">
                  ...
                  <div class="input-group">
                    <span class="input-group-text"><i class="ti ti-topology-complex"></i></span>
                    <input 
                      value="<?= $proveedor->oficina_colonia ?>"
                      placeholder="Colonia"
                      type="text" 
                      id="oficina_colonia" 
              ...
              <div class="col-md-4">
                <div class="mb-3">
                  ...
                  <div class="input-group">
                    <span class="input-group-text"><i class="ti ti-topology-complex"></i></span>
                    <input 
                      value="<?= $proveedor->oficina_ciudad ?>"
                      placeholder="Ciudad"
                      type="text" 
                      id="oficina_ciudad" 
                      name="oficina_ciudad" 
              ...
              <div class="col-md-4">
                <div class="mb-3">
                  ...
                  <div class="input-group">
                    <span class="input-group-text"><i class="ti ti-topology-complex"></i></span>
                    <input 
                      value="<?= $proveedor->oficina_estado ?>"
                      placeholder="Estado"
                      type="text" 
                      id="oficina_estado" 
                      name="oficina_estado" 
              ...
              <div class="col-md-4">
                <div class="mb-3">
                  ...
                  <div class="input-group">
                    <span class="input-group-text"><i class="ti ti-topology-complex"></i></span>
                    <input 
                      value="<?= $proveedor->oficina_codigo_postal ?>"
              ...
              <div class="col-md-4">
                <div class="mb-3">
                  ...
                  <div class="input-group">
                    <span class="input-group-text"><i class="ti ti-topology-complex"></i></span>
                    <input 
                      value="<?= $proveedor->oficina_telefono ?>"
                      placeholder="Teléfono"
                      type="text" 
                      id="oficina_telefono" 
              ...
              <div class="col-md-6">
                <div class="mb-3">
                  ...
                  <div class="input-group">
                    <span class="input-group-text"><i class="ti ti-topology-complex"></i></span>
                    <input 
                      value="<?= $proveedor->oficina_observaciones ?>"
              ...
              <div class="col-md-4">
                <div class="mb-3">
                  ...
                  <div class="input-group">
                    <span class="input-group-text"><i class="ti ti-topology-complex"></i></span>
                    <input 
                      value="<?= $proveedor->fiscal_calle_numero ?>"
                      placeholder="Calle y Número"
                      type="text" 
              ...
              <div class="col-md-4">
                <div class="mb-3">
                  ...
                  <div class="input-group">
                    <span class="input-group-text"><i class="ti ti-topology-complex"></i></span>
                    <input 
                      value="<?= $proveedor->fiscal_colonia ?>"
                      placeholder="Colonia"
                      type="text" 
                      id="fiscal_colonia" 
                      name="fiscal_colonia" 
              ...
              <div class="col-md-4">
                <div class="mb-3">
                  ...
                  <div class="input-group">
                    <span class="input-group-text"><i class="ti ti-topology-complex"></i></span>
                    <input 
                      value="<?= $proveedor->fiscal_codigo_postal ?>"
                      placeholder="Código Postal"
                      type="text" 
              ...
              <div class="col-md-4">
                <div class="mb-3">
                  ...
                  <div class="input-group">
                    <span class="input-group-text"><i class="ti ti-topology-complex"></i></span>
                    <input 
                      value="<?= $proveedor->fiscal_telefono ?>"
                      placeholder="Teléfono"
                      type="text" 
                      id="fiscal_telefono" 
              ...
              <div class="col-md-6">
                <div class="mb-3">
                  ...
                  <div class="input-group">
                    <span class="input-group-text"><i class="ti ti-topology-complex"></i></span>
                    <input 
                      value="<?= $proveedor->fiscal_observaciones ?>"
                      placeholder="Observaciones"
                      type="text" 
