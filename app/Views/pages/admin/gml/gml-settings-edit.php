      ...
      <div class="card w-100">
        <div class="card-body p-4">
          <div class="d-flex justify-content-between align-items-center">
            <h5 class="card-title fw-semibold m-0">Editar remitente</h5>
            <a href="<?= base_url('settings/gml/remitentes') ?>" class="btn btn__simple border d-block"><i class="ti ti-arrow-back"></i> Volver</a>
          </div>
          <form method="post" class="pt-4" action="<?= base_url('settings/gml/remitentes/edit') ?>">
            <?php echo csrf_field(); ?>
            <div class="row">
              <div class="col-md-3">
                <div class="mb-3">
                ...
                <div class="mb-3">
                  ...
                  <div class="input-group">
                    ...
                    <input 
                      ...
                      class="form-control" 
                      required=""
                      value="<?= $remitente->correo_electronico?>"
                    >
                  </div>
                </div>
              </div>
                ...
                <div class="mb-3">
                  ...
                  <div class="input-group">
                    ...
                    <textarea 
                      ...
                      required=""
                      rows="3"
                    ><?= $remitente->referencias?></textarea>
                  </div>
                </div>
              </div>
            </div>
